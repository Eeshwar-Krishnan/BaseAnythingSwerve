...
public class SwerveConstants {
    ...
    public SwerveConstants(double wheelDiameter, double angleGearRatio, double driveGearRatio, double angleKP, double angleKI, double angleKD, boolean driveMotorInvert, boolean angleMotorInvert){
    ...
    public static final class WCP {
        ...
        public static final class SwerveXStandard{
            ...
            public static final SwerveConstants create(double driveGearRatio){
                ...
                return new SwerveConstants(wheelDiameter, angleGearRatio, driveGearRatio, angleKP, angleKI, angleKD, driveMotorInvert, angleMotorInvert);
            }
